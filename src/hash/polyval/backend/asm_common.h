...
// FIXME: Figure out if the compilers we are using have the underscore prefix:
// https://github.com/google/hctr2/blob/fac589e7b88622bda42fb0b9ab3192803363987f/benchmark/meson.build#L13-L16
// #include "cbconfig.h"
