...
#define LOAD_MSG_4_4_(x)                                                    \
  do {                                                                      \
    x = vcombine_u32(vext_u32(m0, m6, 1), vrev64_u32(vext_u32(m6, m4, 1))); \
  } while (0)
...
#define vrorq_n_u32_16(x) \
  vreinterpretq_u32_u16(vrev32q_u16(vreinterpretq_u16_u32(x)))

#define vrorq_n_u32_12(x) vorrq_u32(vshrq_n_u32(x, 12), vshlq_n_u32(x, 20));

#define vrorq_n_u32_8(x) vorrq_u32(vshrq_n_u32(x, 8), vshlq_n_u32(x, 24));

#define vrorq_n_u32_7(x) vorrq_u32(vshrq_n_u32(x, 7), vshlq_n_u32(x, 25));
