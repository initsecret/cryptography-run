...
#define vrorq_n_u64_32(x) \
  vreinterpretq_u64_u32(vrev64q_u32(vreinterpretq_u32_u64((x))))

#define vrorq_n_u64_24(x)                                                    \
  vcombine_u64(                                                              \
      vreinterpret_u64_u8(vext_u8(vreinterpret_u8_u64(vget_low_u64(x)),      \
                                  vreinterpret_u8_u64(vget_low_u64(x)), 3)), \
      vreinterpret_u64_u8(vext_u8(vreinterpret_u8_u64(vget_high_u64(x)),     \
                                  vreinterpret_u8_u64(vget_high_u64(x)), 3)))

#define vrorq_n_u64_16(x)                                                    \
  vcombine_u64(                                                              \
      vreinterpret_u64_u8(vext_u8(vreinterpret_u8_u64(vget_low_u64(x)),      \
                                  vreinterpret_u8_u64(vget_low_u64(x)), 2)), \
      vreinterpret_u64_u8(vext_u8(vreinterpret_u8_u64(vget_high_u64(x)),     \
                                  vreinterpret_u8_u64(vget_high_u64(x)), 2)))
...
#define G1(row1l, row2l, row3l, row4l, row1h, row2h, row3h, row4h, b0, b1) \
  ...
  row4l = vrorq_n_u64_32(row4l);                                           \
  row4h = vrorq_n_u64_32(row4h);                                           \
...
#define G2(row1l, row2l, row3l, row4l, row1h, row2h, row3h, row4h, b0, b1) \
  ...
  row2l = veorq_u64(row2l, row3l);                                         \
  row2h = veorq_u64(row2h, row3h);                                         \
  row2l = vrorq_n_u64_63(row2l);                                           \
  row2h = vrorq_n_u64_63(row2h);
