...
static void rho_whi_enc(uint32_t *state,
                        uint8_t *out,
                        const uint8_t *in,
                        int aligned) {
  uint32_t buffer[RATE_WORDS];
...
static void rho_whi_enc_last(uint32_t *state,
                             uint8_t *out,
                             const uint8_t *in,
                             size_t inlen) {
  uint32_t buffer[RATE_WORDS];
...
static void rho_whi_dec(uint32_t *state,
                        uint8_t *out,
                        const uint8_t *in,
                        int aligned) {
  uint32_t buffer[RATE_WORDS];
...
static void rho_whi_dec_last(uint32_t *state,
                             uint8_t *out,
                             const uint8_t *in,
                             size_t inlen) {
  uint32_t buffer[RATE_WORDS];
...
void ProcessPlainText(uint32_t *state,
                      uint8_t *out,
                      const uint8_t *in,
                      size_t inlen) {
...
void ProcessCipherText(uint32_t *state,
                       uint8_t *out,
                       const uint8_t *in,
                       size_t inlen) {
  // check whether 'in' and 'out' can be casted to uint32_t pointer
...
int crypto_aead_encrypt(UChar *c,
                        ULLInt *clen,
                        const UChar *m,
                        ULLInt mlen,
                        const UChar *ad,
...
int crypto_aead_decrypt(UChar *m,
                        ULLInt *mlen,
                        UChar *nsec,
                        const UChar *c,
                        ULLInt clen,
